    ...
    pub mod garaoh70 {
        pub mod greet {
            ...
            pub mod greetable {
                ...
                #[doc(hidden)]
                macro_rules! __export_garaoh70_greet_greetable_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "garaoh70:greet/greetable#name")] unsafe extern "C" fn
                        export_name() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_name_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_garaoh70:greet/greetable#name")] unsafe extern "C" fn
                        _post_return_name(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_name::<$ty > (arg0) } }
                        #[unsafe (export_name = "garaoh70:greet/greetable#greet")] unsafe
                        ...
                        "cabi_post_garaoh70:greet/greetable#greet")] unsafe extern "C" fn
                        _post_return_greet(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_greet::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_garaoh70_greet_greetable_cabi;
...
macro_rules! __export_greetable_provider_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::garaoh70::greet::greetable::__export_garaoh70_greet_greetable_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::garaoh70::greet::greetable);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:garaoh70:greet:greetable-provider:encoded world"
)]
#[doc(hidden)]
...
\0\x18garaoh70:greet/greetable\x05\0\x04\0!garaoh70:greet/greetable-provider\x04\
